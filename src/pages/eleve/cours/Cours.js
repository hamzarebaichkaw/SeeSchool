...
// useEffect((id) => {     
//   const getData = async () => {  
//     await axios.get('http://www.pointofsaleseedigitalaency.xyz/public/APIUser/ProfileCoursByStudent/1/${id}')  
//     .then(res => {  
//       setmat(res.data)  
//     })  
//     .catch(err => {  
...
CoursM.map(
  ...
  (m)=>( 
       ...
       <button
         onClick={()=>{reg(m.id)}}  
        >  <FolderIcon  style={{width:'200px', height:'200px'}}  />{m.id}{m.matieress }</button> 
