...
import Absence from '../../pages/eleve/absence/Absence'
import Cours from '../../pages/eleve/cours/Cours'
import Elearning from '../../pages/eleve/elearning/Elearning'
import Emploi from '../../pages/eleve/emploi/Emploi'
import Events from '../../pages/eleve/events/Events'
import Homework from '../../pages/eleve/homework/Homework'
        ...
        <div className={classes.root}>
            ...
            >
                ...
                <Switch>
                    ...
                    <Route path="/app/absence" component={Absence} />
                    <Route path="/app/cours" component={Cours} />
                    <Route path="/app/elearning" component={Elearning} />
                    <Route path="/app/emploi" component={Emploi} />
                    <Route path="/app/events" component={Events} />
                    <Route path="/app/homework" component={Homework} />
